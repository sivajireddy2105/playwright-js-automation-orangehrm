...
test('TC03 - Verify user can create, update and delete an employee', async ({ page }) => {
    ...
    // Assert: verify the employee details were saved correctly.
    await expect(pimPage.firstName).toHaveValue(firstName)
    await expect(pimPage.middleName).toHaveValue(middleName)
    await expect(pimPage.lastName).toHaveValue(lastName)
    ...
    await pimPage.verifyEmployeeDeleted(generatedEmployeeId)
